...
public final class ShellUtils {
     ...
     * @return CommandResult
     */
    public static CommandResult execCmd(final boolean isRoot, final String... commands) {
     ...
     * @return CommandResult
     */
    public static CommandResult execCmd(final boolean isRoot, final boolean isNeedResultMsg, final String... commands) {
        return execCmd(commands, isRoot, isNeedResultMsg);
    }
